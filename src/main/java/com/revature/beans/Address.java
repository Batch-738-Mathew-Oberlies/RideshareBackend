...
public class Address implements Serializable {
	...
	public Address(int userId, String userName, Batch batch, String firstName, String lastName, String email,
			String phoneNumber) {
		super();
		this.userId = userId;
	...
	public Address(int userId, @NotBlank String userName, Batch batch, @NotBlank String firstName,
	...
	public void setAddressId(int userId) {
		this.userId = userId;
	}
	public String getAddressName() {
		return userName;
	}
	public void setAddressName(String userName) {
		this.userName = userName;
	}
	...
	public String toString() {
		return "Address [userId=" + userId + ", userName=" + userName + ", batch=" + batch + ", firstName=" + firstName
